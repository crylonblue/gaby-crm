...
export default function ImportPage() {
    ...
    const mapRowToCustomer = (row: any): NewCustomer => {
        ...
        return {
            ...
            healthInsuranceStreet: row["Krankenkasse Straße"] || row["healthInsuranceStreet"] || null,
            healthInsuranceHouseNumber: row["Krankenkasse Hausnr"] || row["healthInsuranceHouseNumber"] || null,
            healthInsurancePostalCode: row["Krankenkasse PLZ"] || row["healthInsurancePostalCode"] || null,
            healthInsuranceCity: row["Krankenkasse Ort"] || row["healthInsuranceCity"] || null,
            healthInsuranceCountry: row["Krankenkasse Land"] || row["healthInsuranceCountry"] || "DE",
